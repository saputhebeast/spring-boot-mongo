package com.example.springmongo.service.ServiceImpl;

import com.example.springmongo.model.Person;
import com.example.springmongo.repository.PersonRepository;
import com.example.springmongo.service.PersonService;
...
public class PersonServiceImpl implements PersonService {
    ...
    public List<Person> getByPersonAge(Integer minAge, Integer maxAge) {
        return personRepository.findPersonByAgeBeween(minAge, maxAge);
    }
    ...
    public Page<Person> search(String name, Integer minAge, Integer maxAge, String city, Pageable pageable) {
        ...
        if(minAge != null && maxAge != null){
            criteria.add(Criteria.where("key").gte(minAge).lte(maxAge));
        }
